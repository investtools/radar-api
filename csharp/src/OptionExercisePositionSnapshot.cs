...
[Serializable]
#endif
public partial class OptionExercisePositionSnapshot : TBase
{
  private long _date;
  ...
  private OptionExerciseType _type;
  ...
  /// <summary>
  /// 
  /// <seealso cref="OptionExerciseType"/>
  /// </summary>
  public OptionExerciseType Type
  {
    get
    {
      return _type;
    ...
    try
    {
      ...
      while (true)
      {
        ...
        switch (field.ID)
        {
          ...
          case 7:
            if (field.Type == TType.I32) {
              Type = (OptionExerciseType)iprot.ReadI32();
            } else { 
              TProtocolUtil.Skip(iprot, field.Type);
            }
            break;
  ...
  public void Write(TProtocol oprot) {
    ...
    try
    {
      TStruct struc = new TStruct("OptionExercisePositionSnapshot");
  ...
  public override string ToString() {
    StringBuilder __sb = new StringBuilder("OptionExercisePositionSnapshot(");
    bool __first = true;
    if (__isset.date) {
