...
public partial class Healthz {
  ...
  public interface Iface : ISync {
    ...
    HealthStatus End_status(IAsyncResult asyncResult);
    #endif
  }
  ...
  public class Client : IDisposable, Iface {
    ...
    public HealthStatus End_status(IAsyncResult asyncResult)
    {
    ...
    public HealthStatus recv_status()
    {
  ...
  {
    private HealthStatus _success;

    /// <summary>
    /// 
    /// <seealso cref="HealthStatus"/>
    /// </summary>
    public HealthStatus Success
    {
      get
      {
        return _success;
          ...
          switch (field.ID)
          {
            case 0:
              if (field.Type == TType.I32) {
                Success = (HealthStatus)iprot.ReadI32();
              } else { 
                TProtocolUtil.Skip(iprot, field.Type);
              }
              break;
