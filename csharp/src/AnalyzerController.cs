  ...
  public class Processor : TProcessor {
    ...
    public void analyzers_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      catch (Exception ex)
      {
        ...
        oprot.WriteMessageBegin(new TMessage("analyzers", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
    ...
    public void create_session_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("create_session", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
    ...
    public void example_result_Process(int seqid, TProtocol iprot, TProtocol oprot)
    {
      ...
      catch (Exception ex)
      {
        ...
        Console.Error.WriteLine(ex.ToString());
        TApplicationException x = new TApplicationException      (TApplicationException.ExceptionType.InternalError," Internal error.");
        oprot.WriteMessageBegin(new TMessage("example_result", TMessageType.Exception, seqid));
        x.Write(oprot);
      }
      oprot.WriteMessageEnd();
      oprot.Transport.Flush();
