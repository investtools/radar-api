...
public class BarSeries implements org.apache.thrift.TBase<BarSeries, BarSeries._Fields>, java.io.Serializable, Cloneable, Comparable<BarSeries> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> data; // required
  /**
   * Criado na versão 0.2.2.
   * 
   * Só é necessário se <code>BarChart.options.stacked = true</code> e a intenção for agrupar as pilhas.
   */
  public @org.apache.thrift.annotation.Nullable java.lang.String stack_name; // optional
  ...
  public BarSeries setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public BarSeries setData(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Double> data) {
    this.data = data;
    return this;
  }
   ...
   * Só é necessário se <code>BarChart.options.stacked = true</code> e a intenção for agrupar as pilhas.
   */
  public BarSeries setStack_name(@org.apache.thrift.annotation.Nullable java.lang.String stack_name) {
