...
public class ReverseSplit implements org.apache.thrift.TBase<ReverseSplit, ReverseSplit._Fields>, java.io.Serializable, Cloneable, Comparable<ReverseSplit> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ReverseSplit");

  private static final org.apache.thrift.protocol.TField DATE_FIELD_DESC = new org.apache.thrift.protocol.TField("date", org.apache.thrift.protocol.TType.I64, (short)1);
  private static final org.apache.thrift.protocol.TField RATIO_FIELD_DESC = new org.apache.thrift.protocol.TField("ratio", org.apache.thrift.protocol.TType.DOUBLE, (short)2);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new ReverseSplitStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new ReverseSplitTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ReverseSplit.class, metaDataMap);
  }
   ...
   */
  public ReverseSplit(ReverseSplit other) {
  ...
  public ReverseSplit deepCopy() {
    return new ReverseSplit(this);
  }
  ...
  public ReverseSplit setDate(long date) {
    this.date = date;
    setDateIsSet(true);
    return this;
  }
  ...
  public ReverseSplit setRatio(double ratio) {
    this.ratio = ratio;
    setRatioIsSet(true);
    return this;
  }
  ...
  public void unsetRatio() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __RATIO_ISSET_ID);
  }

  /** Returns true if field ratio is set (has been assigned a value) and false otherwise */
  public boolean isSetRatio() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __RATIO_ISSET_ID);
  }

  public void setRatioIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __RATIO_ISSET_ID, value);
  }
  ...
  public ReverseSplit setStock(br.com.investtools.radar.api.StockId stock) {
    this.stock = stock;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof ReverseSplit)
      return this.equals((ReverseSplit)that);
    return false;
  }

  public boolean equals(ReverseSplit that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + org.apache.thrift.TBaseHelper.hashCode(ratio);
  ...
  @Override
  public int compareTo(ReverseSplit other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(isSetRatio()).compareTo(other.isSetRatio());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRatio()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("ReverseSplit(");
    boolean first = true;
  ...
  private static class ReverseSplitStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ReverseSplitStandardScheme getScheme() {
      return new ReverseSplitStandardScheme();
    }
  }

  private static class ReverseSplitStandardScheme extends org.apache.thrift.scheme.StandardScheme<ReverseSplit> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ReverseSplit struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ReverseSplit struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ReverseSplitTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public ReverseSplitTupleScheme getScheme() {
      return new ReverseSplitTupleScheme();
    }
  }

  private static class ReverseSplitTupleScheme extends org.apache.thrift.scheme.TupleScheme<ReverseSplit> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ReverseSplit struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ReverseSplit struct) throws org.apache.thrift.TException {
