            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.accepted_events = new HashSet<Event>(2*_set88.size);
                for (int _i89 = 0; _i89 < _set88.size; ++_i89)
                {
                  Event _elem90;
                  _elem90 = Event.findByValue(iprot.readI32());
                  struct.accepted_events.add(_elem90);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, AnalyzerConfig struct) throws org.apache.thrift.TException {
      ...
      if (struct.accepted_events != null) {
        oprot.writeFieldBegin(ACCEPTED_EVENTS_FIELD_DESC);
        {
          ...
          for (Event _iter91 : struct.accepted_events)
          {
      ...
      if (struct.isSetAccepted_events()) {
        {
          ...
          for (Event _iter92 : struct.accepted_events)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.accepted_events = new HashSet<Event>(2*_set93.size);
          for (int _i94 = 0; _i94 < _set93.size; ++_i94)
          {
            Event _elem95;
            _elem95 = Event.findByValue(iprot.readI32());
            struct.accepted_events.add(_elem95);
          }
        }
        struct.setAccepted_eventsIsSet(true);
      }
