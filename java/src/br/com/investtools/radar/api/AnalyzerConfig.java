...
public class AnalyzerConfig implements org.apache.thrift.TBase<AnalyzerConfig, AnalyzerConfig._Fields>, java.io.Serializable, Cloneable, Comparable<AnalyzerConfig> {
  ...
  public java.util.Set<Event> accepted_events; // required
  ...
  public AnalyzerConfig(AnalyzerConfig other) {
    ...
    if (other.isSetAccepted_events()) {
      java.util.Set<Event> __this__accepted_events = new java.util.HashSet<Event>(other.accepted_events.size());
  ...
  public AnalyzerConfig setId(java.lang.String id) {
    this.id = id;
    return this;
  }
  ...
  public AnalyzerConfig setName(java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public void addToAccepted_events(Event elem) {
    if (this.accepted_events == null) {
      this.accepted_events = new java.util.HashSet<Event>();
    }
  ...
  public AnalyzerConfig setAccepted_events(java.util.Set<Event> accepted_events) {
    this.accepted_events = accepted_events;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.accepted_events = new java.util.HashSet<Event>(2*_set96.size);
                Event _elem97;
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.accepted_events = new java.util.HashSet<Event>(2*_set101.size);
          Event _elem102;
