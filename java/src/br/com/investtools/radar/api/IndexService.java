              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<Price>(_list106.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, prices_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Price _iter109 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Price _iter110 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<Price>(_list111.size);
