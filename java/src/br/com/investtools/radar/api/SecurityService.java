...
public class SecurityService {
  ...
  public static class short_name_args implements org.apache.thrift.TBase<short_name_args, short_name_args._Fields>, java.io.Serializable, Cloneable, Comparable<short_name_args>   {
    ...
    public short_name_args setId(br.com.investtools.radar.api.SecurityId id) {
      this.id = id;
      return this;
    }
  ...
  public static class prices_args implements org.apache.thrift.TBase<prices_args, prices_args._Fields>, java.io.Serializable, Cloneable, Comparable<prices_args>   {
    ...
    public prices_args setId(br.com.investtools.radar.api.SecurityId id) {
      this.id = id;
      return this;
    }
  ...
  public static class prices_result implements org.apache.thrift.TBase<prices_result, prices_result._Fields>, java.io.Serializable, Cloneable, Comparable<prices_result>   {
    ...
    public java.util.List<Price> success; // required
    ...
    public prices_result setSuccess(java.util.List<Price> success) {
      this.success = success;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Price>(_list24.size);
                  Price _elem25;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, prices_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Price _iter27 : struct.success)
            {
              _iter27.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Price _iter28 : struct.success)
            {
              _iter28.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Price>(_list29.size);
            Price _elem30;
  ...
  public static class price_args implements org.apache.thrift.TBase<price_args, price_args._Fields>, java.io.Serializable, Cloneable, Comparable<price_args>   {
    ...
    public price_args setId(br.com.investtools.radar.api.SecurityId id) {
      this.id = id;
      return this;
    }
  ...
  public static class price_change_args implements org.apache.thrift.TBase<price_change_args, price_change_args._Fields>, java.io.Serializable, Cloneable, Comparable<price_change_args>   {
    ...
    public price_change_args setId(br.com.investtools.radar.api.SecurityId id) {
      this.id = id;
      return this;
    }
  ...
  public static class price_changes_args implements org.apache.thrift.TBase<price_changes_args, price_changes_args._Fields>, java.io.Serializable, Cloneable, Comparable<price_changes_args>   {
    ...
    public price_changes_args setId(br.com.investtools.radar.api.SecurityId id) {
      this.id = id;
      return this;
    }
  ...
  public static class price_changes_result implements org.apache.thrift.TBase<price_changes_result, price_changes_result._Fields>, java.io.Serializable, Cloneable, Comparable<price_changes_result>   {
    ...
    public price_changes_result setSuccess(java.util.List<java.lang.Double> success) {
      this.success = success;
      return this;
    }
  ...
  public static class price_volatility_args implements org.apache.thrift.TBase<price_volatility_args, price_volatility_args._Fields>, java.io.Serializable, Cloneable, Comparable<price_volatility_args>   {
    ...
    public price_volatility_args setId(br.com.investtools.radar.api.SecurityId id) {
      this.id = id;
      return this;
    }
