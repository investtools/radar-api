              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<AnalyzerConfig>(_list128.size);
                  for (int _i129 = 0; _i129 < _list128.size; ++_i129)
                  {
                    AnalyzerConfig _elem130;
                    _elem130 = new AnalyzerConfig();
                    _elem130.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, analyzers_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (AnalyzerConfig _iter131 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (AnalyzerConfig _iter132 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<AnalyzerConfig>(_list133.size);
            for (int _i134 = 0; _i134 < _list133.size; ++_i134)
            {
              AnalyzerConfig _elem135;
              _elem135 = new AnalyzerConfig();
              _elem135.read(iprot);
