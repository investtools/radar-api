              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<AnalyzerConfig>(_list122.size);
                  for (int _i123 = 0; _i123 < _list122.size; ++_i123)
                  {
                    AnalyzerConfig _elem124;
                    _elem124 = new AnalyzerConfig();
                    _elem124.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, analyzers_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (AnalyzerConfig _iter125 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (AnalyzerConfig _iter126 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<AnalyzerConfig>(_list127.size);
            for (int _i128 = 0; _i128 < _list127.size; ++_i128)
            {
              AnalyzerConfig _elem129;
              _elem129 = new AnalyzerConfig();
              _elem129.read(iprot);
