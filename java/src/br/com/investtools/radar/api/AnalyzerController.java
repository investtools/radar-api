...
public class AnalyzerController {
  ...
  public interface AsyncIface {
    ...
    public void on_each_month(short sessionid, Portfolio portfolio, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void on_cash_flow(short session_id, CashFlow cash_flow, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
    ...
    public void example_result(short session_id, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class on_each_month_call extends org.apache.thrift.async.TAsyncMethodCall {
      private short sessionid;
      private Portfolio portfolio;
    ...
    public static class on_cash_flow_call extends org.apache.thrift.async.TAsyncMethodCall {
      private short session_id;
      private CashFlow cash_flow;
      public on_cash_flow_call(short session_id, CashFlow cash_flow, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, true);
        this.session_id = session_id;
    ...
    public static class example_result_call extends org.apache.thrift.async.TAsyncMethodCall {
      private short session_id;
      public example_result_call(short session_id, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.session_id = session_id;
      }
      ...
      public void getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_example_result();
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class on_each_month<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, on_each_month_args, Void> {
      ...
      public void start(I iface, on_each_month_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
    ...
    public static class on_cash_flow<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, on_cash_flow_args, Void> {
      ...
      public void start(I iface, on_cash_flow_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
    ...
    public static class example_result<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, example_result_args, Void> {
      ...
      public void start(I iface, example_result_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
...
;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<AnalyzerConfig>(_list104.size);
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<AnalyzerConfig>(_list109.size);
  ...
  public static class on_each_month_args implements org.apache.thrift.TBase<on_each_month_args, on_each_month_args._Fields>, java.io.Serializable, Cloneable, Comparable<on_each_month_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new on_each_month_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new on_each_month_argsTupleSchemeFactory());
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("on_each_month_args(");
      boolean first = true;
    ...
    private static class on_each_month_argsStandardSchemeFactory implements SchemeFactory {
      public on_each_month_argsStandardScheme getScheme() {
        return new on_each_month_argsStandardScheme();
      }
    }

    private static class on_each_month_argsStandardScheme extends StandardScheme<on_each_month_args> {
    ...
    private static class on_each_month_argsTupleSchemeFactory implements SchemeFactory {
      public on_each_month_argsTupleScheme getScheme() {
        return new on_each_month_argsTupleScheme();
      }
    }

    private static class on_each_month_argsTupleScheme extends TupleScheme<on_each_month_args> {
  ...
  public static class on_cash_flow_args implements org.apache.thrift.TBase<on_cash_flow_args, on_cash_flow_args._Fields>, java.io.Serializable, Cloneable, Comparable<on_cash_flow_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new on_cash_flow_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new on_cash_flow_argsTupleSchemeFactory());
    }
    ...
    public int hashCode() {
      ...
      boolean present_cash_flow = true && (isSetCash_flow());
      list.add(present_cash_flow);
      if (present_cash_flow)
        list.add(cash_flow);
    ...
    public int compareTo(on_cash_flow_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetCash_flow()).compareTo(other.isSetCash_flow());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetCash_flow()) {
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("on_cash_flow_args(");
      boolean first = true;
    ...
    private static class on_cash_flow_argsStandardSchemeFactory implements SchemeFactory {
      public on_cash_flow_argsStandardScheme getScheme() {
        return new on_cash_flow_argsStandardScheme();
      }
    }

    private static class on_cash_flow_argsStandardScheme extends StandardScheme<on_cash_flow_args> {
    ...
    private static class on_cash_flow_argsTupleSchemeFactory implements SchemeFactory {
      public on_cash_flow_argsTupleScheme getScheme() {
        return new on_cash_flow_argsTupleScheme();
      }
    }

    private static class on_cash_flow_argsTupleScheme extends TupleScheme<on_cash_flow_args> {
  ...
  public static class example_result_args implements org.apache.thrift.TBase<example_result_args, example_result_args._Fields>, java.io.Serializable, Cloneable, Comparable<example_result_args>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new example_result_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new example_result_argsTupleSchemeFactory());
    }
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("example_result_args(");
      boolean first = true;
    ...
    private static class example_result_argsStandardSchemeFactory implements SchemeFactory {
      public example_result_argsStandardScheme getScheme() {
        return new example_result_argsStandardScheme();
      }
    }

    private static class example_result_argsStandardScheme extends StandardScheme<example_result_args> {
    ...
    private static class example_result_argsTupleSchemeFactory implements SchemeFactory {
      public example_result_argsTupleScheme getScheme() {
        return new example_result_argsTupleScheme();
      }
    }

    private static class example_result_argsTupleScheme extends TupleScheme<example_result_args> {
  ...
  public static class example_result_result implements org.apache.thrift.TBase<example_result_result, example_result_result._Fields>, java.io.Serializable, Cloneable, Comparable<example_result_result>   {
    ...
    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new example_result_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new example_result_resultTupleSchemeFactory());
    }
...
;
    ...
    @Override
    public String toString() {
      StringBuilder sb = new StringBuilder("example_result_result(");
      boolean first = true;
    ...
    private static class example_result_resultStandardSchemeFactory implements SchemeFactory {
      public example_result_resultStandardScheme getScheme() {
        return new example_result_resultStandardScheme();
      }
    }

    private static class example_result_resultStandardScheme extends StandardScheme<example_result_result> {
    ...
    private static class example_result_resultTupleSchemeFactory implements SchemeFactory {
      public example_result_resultTupleScheme getScheme() {
        return new example_result_resultTupleScheme();
      }
    }

    private static class example_result_resultTupleScheme extends TupleScheme<example_result_result> {
