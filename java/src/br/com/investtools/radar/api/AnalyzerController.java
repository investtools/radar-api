...
public class AnalyzerController {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class on_each_month_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("on_each_month", org.apache.thrift.protocol.TMessageType.CALL, 0));
        on_each_month_args args = new on_each_month_args();
        args.setSessionid(sessionid);
        args.setPortfolio(portfolio);
        args.write(prot);
    ...
    public static class on_cash_flow_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("on_cash_flow", org.apache.thrift.protocol.TMessageType.CALL, 0));
        on_cash_flow_args args = new on_cash_flow_args();
        args.setSession_id(session_id);
        args.setCash_flow(cash_flow);
        args.write(prot);
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new ArrayList<AnalyzerConfig>(_list120.size);
                  for (int _i121 = 0; _i121 < _list120.size; ++_i121)
                  {
                    AnalyzerConfig _elem122;
                    _elem122 = new AnalyzerConfig();
                    _elem122.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, analyzers_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (AnalyzerConfig _iter123 : struct.success)
            {
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (AnalyzerConfig _iter124 : struct.success)
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new ArrayList<AnalyzerConfig>(_list125.size);
            for (int _i126 = 0; _i126 < _list125.size; ++_i126)
            {
              AnalyzerConfig _elem127;
              _elem127 = new AnalyzerConfig();
              _elem127.read(iprot);
