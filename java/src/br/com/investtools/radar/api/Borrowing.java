...
public class Borrowing implements org.apache.thrift.TBase<Borrowing, Borrowing._Fields>, java.io.Serializable, Cloneable, Comparable<Borrowing> {
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(Borrowing.class, metaDataMap);
  }
  ...
  public Borrowing setStock(br.com.investtools.radar.api.StockId stock) {
    this.stock = stock;
    return this;
  }
  ...
  public Borrowing setShares(int shares) {
    this.shares = shares;
    setSharesIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof Borrowing)
      return this.equals((Borrowing)that);
    return false;
  }

  public boolean equals(Borrowing that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  private static class BorrowingStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public BorrowingStandardScheme getScheme() {
      return new BorrowingStandardScheme();
    }
  }

  private static class BorrowingStandardScheme extends org.apache.thrift.scheme.StandardScheme<Borrowing> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, Borrowing struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Borrowing struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class BorrowingTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public BorrowingTupleScheme getScheme() {
      return new BorrowingTupleScheme();
    }
  }

  private static class BorrowingTupleScheme extends org.apache.thrift.scheme.TupleScheme<Borrowing> {
