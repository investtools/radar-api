...
public class Portfolio implements org.apache.thrift.TBase<Portfolio, Portfolio._Fields>, java.io.Serializable, Cloneable, Comparable<Portfolio> {
  ...
  private static final org.apache.thrift.protocol.TField POSITIONS_FIELD_DESC = new org.apache.thrift.protocol.TField("positions", org.apache.thrift.protocol.TType.MAP, (short)2);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.positions = new HashMap<String,Position>(2*_map80.size);
                for (int _i81 = 0; _i81 < _map80.size; ++_i81)
                {
                  ...
                  _val83 = new Position();
                  _val83.read(iprot);
                  struct.positions.put(_key82, _val83);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Portfolio struct) throws org.apache.thrift.TException {
      ...
      if (struct.positions != null) {
        oprot.writeFieldBegin(POSITIONS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Position> _iter84 : struct.positions.entrySet())
          {
      ...
      if (struct.isSetPositions()) {
        {
          ...
          for (Map.Entry<String, Position> _iter85 : struct.positions.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.positions = new HashMap<String,Position>(2*_map86.size);
          for (int _i87 = 0; _i87 < _map86.size; ++_i87)
          {
            ...
            _val89 = new Position();
            _val89.read(iprot);
            struct.positions.put(_key88, _val89);
          }
        }
        struct.setPositionsIsSet(true);
      }
