...
service TransactionImporter {
  ...
  map<common.SecurityId,i32> fetch_portfolio(1: string username, 2: string password, 3: common.Date date) throws (1: AuthenticationError auth_error, 2: SystemUnavailableError system_unavailable)
}
