...
goog.exportSymbol('proto.Radar.GenerateResp.TypeCase', null, global);
...
/**
 * @param {string} value
 * @return {!proto.Radar.Metadata} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.Radar.GenerateReq} returns this
 */
 ...
 * @return {!proto.Radar.GenerateResp} returns this
*/
proto.Radar.GenerateResp.prototype.setMetadata = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.Radar.GenerateResp.oneofGroups_[0], value);
};
...
proto.Radar.GenerateResp.prototype.setChunk = function(value) {
  return jspb.Message.setOneofField(this, 2, proto.Radar.GenerateResp.oneofGroups_[0], value);
};
...
proto.Radar.GenerateResp.prototype.clearChunk = function() {
  return jspb.Message.setOneofField(this, 2, proto.Radar.GenerateResp.oneofGroups_[0], undefined);
};
