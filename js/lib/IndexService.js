...
IndexService_prices_args = function(args) {
  this.symbol = null;
...
IndexService_prices_result = function(args) {
  this.success = null;
  if (args) {
...
IndexService_price_args = function(args) {
  this.symbol = null;
  this.date = null;
  if (args) {
    if (args.symbol !== undefined) {
...
IndexService_price_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
IndexService_price_change_args = function(args) {
  this.symbol = null;
  this.start_date = null;
  this.end_date = null;
  if (args) {
...
IndexService_price_change_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined) {
      this.success = args.success;
...
IndexServiceClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
IndexServiceProcessor = exports.Processor = function(handler) {
  ...
  if (this._handler.prices.length === 3) {
    Q.fcall(this._handler.prices, args.symbol, args.start_date, args.end_date)
      .then(function(result) {
        var result = new IndexService_prices_result({success: result});
        output.writeMessageBegin("prices", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new IndexService_prices_result(err);
        output.writeMessageBegin("prices", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.prices(args.symbol, args.start_date, args.end_date,  function (err, result) {
      var result = new IndexService_prices_result((err != null ? err : {success: result}));
      output.writeMessageBegin("prices", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
IndexServiceProcessor.prototype.process_price = function(seqid, input, output) {
  ...
  if (this._handler.price.length === 2) {
    Q.fcall(this._handler.price, args.symbol, args.date)
      .then(function(result) {
        var result = new IndexService_price_result({success: result});
        output.writeMessageBegin("price", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new IndexService_price_result(err);
        output.writeMessageBegin("price", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.price(args.symbol, args.date,  function (err, result) {
      var result = new IndexService_price_result((err != null ? err : {success: result}));
      output.writeMessageBegin("price", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
...
IndexServiceProcessor.prototype.process_price_change = function(seqid, input, output) {
  ...
  if (this._handler.price_change.length === 3) {
    Q.fcall(this._handler.price_change, args.symbol, args.start_date, args.end_date)
      .then(function(result) {
        var result = new IndexService_price_change_result({success: result});
        output.writeMessageBegin("price_change", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result = new IndexService_price_change_result(err);
        output.writeMessageBegin("price_change", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.price_change(args.symbol, args.start_date, args.end_date,  function (err, result) {
      var result = new IndexService_price_change_result((err != null ? err : {success: result}));
      output.writeMessageBegin("price_change", Thrift.MessageType.REPLY, seqid);
      result.write(output);
      output.writeMessageEnd();
      output.flush();
