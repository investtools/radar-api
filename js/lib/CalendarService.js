...
CalendarServiceClient.prototype.send_advance = function(calendar, date, n) {
  ...
  var args = new CalendarService_advance_args(params);
  try {
...
CalendarServiceClient.prototype.send_back = function(calendar, date, n) {
  ...
  var args = new CalendarService_back_args(params);
  try {
...
CalendarServiceClient.prototype.send_first_business_day = function(calendar, date) {
  ...
  var args = new CalendarService_first_business_day_args(params);
  try {
...
CalendarServiceProcessor.prototype.process_advance = function(seqid, input, output) {
  ...
  if (this._handler.advance.length === 3) {
    Q.fcall(this._handler.advance.bind(this._handler),
      args.calendar,
      args.date,
      args.n
...
CalendarServiceProcessor.prototype.process_back = function(seqid, input, output) {
  ...
  if (this._handler.back.length === 3) {
    Q.fcall(this._handler.back.bind(this._handler),
      args.calendar,
      args.date,
      args.n
    ).then(function(result) {
...
CalendarServiceProcessor.prototype.process_first_business_day = function(seqid, input, output) {
  ...
  if (this._handler.first_business_day.length === 2) {
    Q.fcall(this._handler.first_business_day.bind(this._handler),
      args.calendar,
      args.date
    ).then(function(result) {
