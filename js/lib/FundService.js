...
var FundService_name_args = function(args) {
  this.id = null;
  if (args) {
...
var FundService_name_result = function(args) {
  this.success = null;
  if (args) {
...
var FundService_short_name_args = function(args) {
  this.id = null;
  if (args) {
    if (args.id !== undefined && args.id !== null) {
      this.id = new common_ttypes.FundId(args.id);
...
var FundService_short_name_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = args.success;
...
var FundService_daily_data_args = function(args) {
  this.id = null;
  this.date = null;
  if (args) {
    if (args.id !== undefined && args.id !== null) {
...
var FundService_daily_data_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
...
var FundServiceClient = exports.Client = function(output, pClass) {
  this.output = output;
  this.pClass = pClass;
  this._seqid = 0;
  this._reqs = {};
...
FundServiceClient.prototype.send_name = function(id) {
  ...
  var args = new FundService_name_args(params);
  try {
...
FundServiceClient.prototype.send_short_name = function(id) {
  ...
  var args = new FundService_short_name_args(params);
  try {
...
FundServiceClient.prototype.send_daily_data = function(id, date) {
  ...
  var args = new FundService_daily_data_args(params);
  try {
...
var FundServiceProcessor = exports.Processor = function(handler) {
...
FundServiceProcessor.prototype.process_name = function(seqid, input, output) {
  ...
  if (this._handler.name.length === 1) {
    Q.fcall(this._handler.name.bind(this._handler),
      args.id
    ).then(function(result) {
      var result_obj = new FundService_name_result({success: result});
    ...
    this._handler.name(args.id, function (err, result) {
      ...
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new FundService_name_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("name", Thrift.MessageType.REPLY, seqid);
      } else {
...
FundServiceProcessor.prototype.process_short_name = function(seqid, input, output) {
  ...
  if (this._handler.short_name.length === 1) {
    Q.fcall(this._handler.short_name.bind(this._handler),
      ...
      var result_obj = new FundService_short_name_result({success: result});
    ...
    this._handler.short_name(args.id, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new FundService_short_name_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("short_name", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("short_name", Thrift.MessageType.EXCEPTION, seqid);
...
FundServiceProcessor.prototype.process_daily_data = function(seqid, input, output) {
  ...
  if (this._handler.daily_data.length === 2) {
    Q.fcall(this._handler.daily_data.bind(this._handler),
      args.id,
      args.date
    ).then(function(result) {
      var result_obj = new FundService_daily_data_result({success: result});
    ...
    this._handler.daily_data(args.id, args.date, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined')) {
        result_obj = new FundService_daily_data_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("daily_data", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("daily_data", Thrift.MessageType.EXCEPTION, seqid);
