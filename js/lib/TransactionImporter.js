...
TransactionImporter_name_args = function(args) {
};
...
TransactionImporter_name_result = function(args) {
  this.success = null;
  if (args) {
...
TransactionImporter_accounts_args = function(args) {
  this.username = null;
  this.password = null;
  if (args) {
...
TransactionImporter_accounts_result = function(args) {
  this.success = null;
...
TransactionImporter_fetch_args = function(args) {
  this.username = null;
  this.password = null;
  this.accounts = null;
  if (args) {
...
TransactionImporter_fetch_result = function(args) {
  this.success = null;
  this.auth_error = null;
  if (args instanceof ttypes.AuthenticationError) {
    this.auth_error = args;
...
TransactionImporterClient = exports.Client = function(output, pClass) {
    this.output = output;
    this.pClass = pClass;
    this._seqid = 0;
    this._reqs = {};
...
TransactionImporterProcessor = exports.Processor = function(handler) {
  ...
  if (this._handler.name.length === 0) {
    Q.fcall(this._handler.name)
      .then(function(result) {
        var result = new TransactionImporter_name_result({success: result});
    ...
    this._handler.name(function (err, result) {
      if (err == null) {
        var result = new TransactionImporter_name_result((err != null ? err : {success: result}));
        output.writeMessageBegin("name", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("name", Thrift.MessageType.EXCEPTION, seqid);
...
TransactionImporterProcessor.prototype.process_accounts = function(seqid, input, output) {
  ...
  if (this._handler.accounts.length === 2) {
    Q.fcall(this._handler.accounts, args.username, args.password)
      .then(function(result) {
        var result = new TransactionImporter_accounts_result({success: result});
        output.writeMessageBegin("accounts", Thrift.MessageType.REPLY, seqid);
        result.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        if (err instanceof ttypes.AuthenticationError) {
          var result = new TransactionImporter_accounts_result(err);
          output.writeMessageBegin("accounts", Thrift.MessageType.REPLY, seqid);
        } else {
          var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.accounts(args.username, args.password, function (err, result) {
      if (err == null || err instanceof ttypes.AuthenticationError) {
        var result = new TransactionImporter_accounts_result((err != null ? err : {success: result}));
        output.writeMessageBegin("accounts", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("accounts", Thrift.MessageType.EXCEPTION, seqid);
...
TransactionImporterProcessor.prototype.process_fetch = function(seqid, input, output) {
  ...
  if (this._handler.fetch.length === 3) {
    Q.fcall(this._handler.fetch, args.username, args.password, args.accounts)
      .then(function(result) {
        var result = new TransactionImporter_fetch_result({success: result});
        ...
        if (err instanceof ttypes.AuthenticationError) {
          var result = new TransactionImporter_fetch_result(err);
          output.writeMessageBegin("fetch", Thrift.MessageType.REPLY, seqid);
        } else {
          var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
    ...
    this._handler.fetch(args.username, args.password, args.accounts, function (err, result) {
      if (err == null || err instanceof ttypes.AuthenticationError) {
        var result = new TransactionImporter_fetch_result((err != null ? err : {success: result}));
        output.writeMessageBegin("fetch", Thrift.MessageType.REPLY, seqid);
      } else {
        var result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("fetch", Thrift.MessageType.EXCEPTION, seqid);
