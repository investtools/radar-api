...
export namespace Event {
  ...
  export class EquitySource extends jspb.Message {
    ...
    getType(): Event.EquityTypeMap[keyof Event.EquityTypeMap];
    setType(value: Event.EquityTypeMap[keyof Event.EquityTypeMap]): void;
  ...
  export namespace EquitySource {
    export type AsObject = {
      symbol: string,
      type: Event.EquityTypeMap[keyof Event.EquityTypeMap],
    }
  }
  ...
  export class CashFlow extends jspb.Message {
    getType(): Event.CashFlow.TypeMap[keyof Event.CashFlow.TypeMap];
    setType(value: Event.CashFlow.TypeMap[keyof Event.CashFlow.TypeMap]): void;
  ...
  export namespace CashFlow {
    export type AsObject = {
      type: Event.CashFlow.TypeMap[keyof Event.CashFlow.TypeMap],
      value: number,
  ...
  export namespace Portfolio {
    ...
    export class Position extends jspb.Message {
      ...
      getEquityType(): Event.EquityTypeMap[keyof Event.EquityTypeMap];
      setEquityType(value: Event.EquityTypeMap[keyof Event.EquityTypeMap]): void;
    ...
    export namespace Position {
      export type AsObject = {
        ...
        value: number,
        avgPrice: number,
        equityType: Event.EquityTypeMap[keyof Event.EquityTypeMap],
      }
    }
  ...
  export class PositionMonthTax extends jspb.Message {
    getPositionType(): Event.PositionTypeMap[keyof Event.PositionTypeMap];
    setPositionType(value: Event.PositionTypeMap[keyof Event.PositionTypeMap]): void;
  ...
  export namespace PositionMonthTax {
    export type AsObject = {
      positionType: Event.PositionTypeMap[keyof Event.PositionTypeMap],
      equityType: Event.EquityTypeMap[keyof Event.EquityTypeMap],
      value: number,
    }
  }
  ...
  export interface EquityTypeMap {
    OTHER: 0;
    STOCK: 1;
    OPTION: 2;
    REIT: 3;
  ...
  export const EquityType: EquityTypeMap;
...
export class RunReq extends jspb.Message {
  ...
  getEventsList(): Array<RunReq.EventMap[keyof RunReq.EventMap]>;
  setEventsList(value: Array<RunReq.EventMap[keyof RunReq.EventMap]>): void;
  addEvents(value: RunReq.EventMap[keyof RunReq.EventMap], index?: number): RunReq.EventMap[keyof RunReq.EventMap];
...
export namespace RunReq {
  export type AsObject = {
    userId: string,
    portfolioId: string,
    eventsList: Array<RunReq.EventMap[keyof RunReq.EventMap]>,
