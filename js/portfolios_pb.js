...
goog.exportSymbol('proto.Radar.RunReq.Events', null, global);
 ...
 * @const
 */
proto.Radar.Event.oneofGroups_ = [[20,21]];
...
proto.Radar.Event.Portfolio.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    provisionsList: jspb.Message.toObjectList(msg.getProvisionsList(),
 ...
 */
proto.Radar.Event.Portfolio.prototype.getPositionsList = function() {
...
proto.Radar.Event.Portfolio.prototype.setPositionsList = function(value) {
 ...
 * @return {!proto.Radar.Event.Portfolio.Position}
 */
proto.Radar.Event.Portfolio.prototype.addPositions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.Radar.Event.Portfolio.Position, opt_index);
};


proto.Radar.Event.Portfolio.prototype.clearPositionsList = function() {
 ...
 */
proto.Radar.Event.Portfolio.prototype.getProvisionsList = function() {
...
proto.Radar.Event.Portfolio.prototype.setProvisionsList = function(value) {
 ...
 * @return {!proto.Radar.Event.Portfolio.Provision}
 */
proto.Radar.Event.Portfolio.prototype.addProvisions = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.Radar.Event.Portfolio.Provision, opt_index);
};


proto.Radar.Event.Portfolio.prototype.clearProvisionsList = function() {
...
proto.Radar.RunReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.Radar.RunReq.Events} */ (reader.readEnum());
      msg.setEvents(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.Radar.RunReq.Events}
 */
proto.Radar.RunReq.prototype.getEvents = function() {
  return /** @type {!proto.Radar.RunReq.Events} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.Radar.RunReq.Events} value */
proto.Radar.RunReq.prototype.setEvents = function(value) {
